...
describe('ms2Unit', () => {
  it('ms2Unit', () => {
    ...
    expect(ms2Unit(1002,'')).toBe('1秒2毫秒');
    expect(ms2Unit(60 * 1000)).toBe('1分钟');
    expect(ms2Unit(69999,)).toBe('1分钟又9秒');
    expect(ms2Unit(69999, '', 0)).toBe('1分钟');
    expect(ms2Unit(69999)).toBe('1分钟又9秒');
    expect(ms2Unit(69999, '', 2)).toBe('1分钟9秒999毫秒');
    ...
    expect(ms2Unit(60 * 60 * 1000 * 24 * 365, '', 2)).toBe('1年');
